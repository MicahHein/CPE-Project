...
public class AnimalQuizzz : MonoBehaviour
{
    ...
    public VideoClip AnimalVideoClip;

    public GameObject quizTopicButtons;


    public GameObject AnimalChoices;
    ...
    public GameObject AlphabetsChoices;
    ...
    public void AnimalVideo()
    {
        ...
        videoPlayer.clip = AnimalVideoClip;
