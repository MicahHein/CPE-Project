...
public class DirectionsQuizzz : MonoBehaviour
{
    ...
    public VideoClip DirectionsVideoClip;
    ...
    public void DirectionsButtonOne()
    {
    ...
    public void DirectionsButtonTwo()
    {
        if (currentIndex < 5)
        {
            userSequence.Add(2);
    ...
    public void DirectionsButtonThree()
    {
        if (currentIndex < 5)
        {
            userSequence.Add(3);
    ...
    public void DirectionsButtonFour()
    {
        if (currentIndex < 5)
        {
            userSequence.Add(4);
    ...
    public void DirectionsButtonFive()
    {
        if (currentIndex < 5)
        {
            userSequence.Add(5);
