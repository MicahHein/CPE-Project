...
public class FruitQuizzz : MonoBehaviour
{
    ...
    public VideoClip FruitVideoClip;
    ...
    public void FruitVideo()
    {
        ...
        videoPlayer.clip = FruitVideoClip;
