...
public class HobbiesQuizzz : MonoBehaviour
{
    ...
    public VideoClip HobbiesVideoClip;
    ...
    public void HobbiesButtonThree()
    {
        if (currentIndex < 5)
        {
            userSequence.Add(3);
