...
public class NumbersQuizzz : MonoBehaviour
{
    ...
    public VideoClip NumbersVideoClip;
    ...
    public void NumbersButtonThree()
    {
        if (currentIndex < 5)
        {
            userSequence.Add(3);
