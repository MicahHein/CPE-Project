...
public class alphabetQuizHopefullyFinal : MonoBehaviour
{
    ...
    public void alphabetQuiz()
    {
        ...
        AlphabetChoices.SetActive(true);
    ...
    public void AlphabetButtonThree()
    {
        if (currentIndex < 5)
        {
            userSequence.Add(3);
    ...
    public void AlphabetButtonFour()
    {
        if (currentIndex < 5)
        {
            userSequence.Add(4);
    ...
    public void AlphabetButtonFive()
    {
        if (currentIndex < 5)
        {
            userSequence.Add(5);
